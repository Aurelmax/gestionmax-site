...
export namespace Prisma {
  ...
  */
  ...
  export type LearnerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "firstName" | "lastName" | "email" | "createdAt", ExtArgs["result"]["learner"]>
  ...
  interface LearnerFieldRefs {
    ...
    readonly firstName: FieldRef<"Learner", 'String'>
    readonly lastName: FieldRef<"Learner", 'String'>
  ...
  export type LearnerWhereInput = {
    ...
    firstName?: StringFilter<"Learner"> | string
    lastName?: StringFilter<"Learner"> | string
  ...
  export type LearnerScalarWhereWithAggregatesInput = {
    ...
    firstName?: StringWithAggregatesFilter<"Learner"> | string
    lastName?: StringWithAggregatesFilter<"Learner"> | string
